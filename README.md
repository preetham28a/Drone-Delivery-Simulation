# team-010-30-finalproject

# Team Number: Team-010-30

# Team Members:


Benjamin Sebastian (sebas063)
Aarussh Vaid (vaid0027)
Srinivas Preetham Addepalli (addep011)
Nitish Kumar Yarlagadda (yarla021)

What is the project about? This should be an overview of the whole project, not
just your extension
...
How do you run the simulation? This should also be an overview of the whole
project, not just your extension

//TODO after pushing to Docker
...
What does the simulation do specifically? This should be an overview of the
entire project and cover individual features such as movement of entities, etc.
...
Pair Programming to better utilize our strengths
Seamless Integration into the final product
Code reviews helped maintain code quality

What could be improved:

Better understanding of various design patterns would have sped up the learning curve.

Better understanding of GitHub’s merge conflict resolution process would have avoided problems with commits.

Better Communication with each other would have been good to get timelines synced and task requirements clarified.

What will we commit to improve in the next Sprint:

We will have more meetings with each other besides integration to get a good understanding of what is going on and make sure timely progress is being made.

Explore tools and design patterns more and establish better familiarity with them.


[Docker Link](https://hub.docker.com/repository/docker/nitishkumar021/team-010-code-final/general)


[Youtube Video Link](https://youtu.be/Z70Inx3SX-Q)
